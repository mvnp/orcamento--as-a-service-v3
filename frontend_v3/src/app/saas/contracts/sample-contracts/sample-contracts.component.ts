...
@Component({
    selector: 'app-sample-contracts',
    templateUrl: './sample-contracts.component.html',
    styleUrls: ['./sample-contracts.component.css']
})
export class SampleContractsComponent implements OnInit {

    @ViewChild(MatPaginator) paginator: MatPaginator;
    @ViewChild(MatSort) sort: MatSort;
    @ViewChild(MatTable) table: MatTable<any>;

    displayedColumns: string[] = ['id', 'title', 'import', 'download'];
    ...
    getAllContractsSample() {
        ...
        this._contractsService.getAllContractsSample().subscribe({
            next: (samples: any) => {
                ...
                this.dataSource = new MatTableDataSource<any>(samples.data);
