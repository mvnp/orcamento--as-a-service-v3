...
@Component({
    selector: 'app-reports-observations',
    templateUrl: './reports-observations.component.html',
    styleUrls: ['./reports-observations.component.css']
})
export class ReportsObservationsComponent implements OnInit {

    @ViewChild(MatPaginator) paginator: MatPaginator;
    @ViewChild(MatSort) sort: MatSort;
    @ViewChild(MatTable) table: MatTable<any>;

    displayedColumns: string[] = ['id', 'name', 'date', 'edit', 'remove'];
    ...
    getAllObservations() {
        this._loader.show();
        this._reportsService.getAllObservations().subscribe({
            next: (reports: any) => {
                console.log(reports);
